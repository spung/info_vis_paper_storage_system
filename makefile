...
DVIFILES = storage_system_infovis.dvi
MAINTEXFILE = $(DVIFILES:.dvi=.tex)
SUBTEXFILES = 
BIBFILES = storage_system_infovis.bib
...
clean: 
				...
				*.inx *.toc *.out $(DVIFILES) $(PSFILES) storage_system_infovis.pdf *~
